...
class CategoriesController extends BackendController
{
    ...
    public function store(CategoryStoreRequest $request)
    {
        ...
        return redirect('/backend/categories')->with('message', 'Your category was created successfully!');
    }
    ...
    public function update(CategoryUpdateRequest $request, $id)
    {
        ...
        return redirect('/backend/categories')->with('message', 'Your category was updatedc successfully!');
    }
    ...
    public function destroy(CategoryDestroyRequest $request, $id)
    {
        ...
        return redirect('/backend/categories')->with('message', 'Your category was deleted successfully!');
    }
}
